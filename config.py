...
# --- CHANNELS (Force Sub Removed) ---
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003626737474"))
FORCE_SUB_CHANNEL = None # यहाँ से चैनल हटा दिया गया है
FORCE_SUB_LINK = None    # लिंक भी हटा दिया गया है
...
# FORCE_MSG की अब ज़रूरत नहीं है इसलिए इसे हटा सकते हैं
